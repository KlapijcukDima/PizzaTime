...
<header class="header-page">
  <div class="container header-page__container">
    <div class="header-page__start">
      <div class="logo">
        <img class="logo__img lazy" src="<?php echo get_template_directory_uri(); ?>/assets/img/common/logo.svg" alt="" width="127" height="21">
      </div>
    </div>
    <div class="header-page__end">
      ...
      <div class="phone">
        <a class="phone__item header-page__phone" href="tel:+3809999999999">+380 (999) 999-99-99</a>
      </div>
